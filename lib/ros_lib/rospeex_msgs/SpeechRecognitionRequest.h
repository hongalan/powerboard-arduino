#ifndef _ROS_rospeex_msgs_SpeechRecognitionRequest_h
#define _ROS_rospeex_msgs_SpeechRecognitionRequest_h
...
namespace rospeex_msgs
{
  ...
  class SpeechRecognitionRequest : public ros::Msg
  {
    ...
    const char * getType(){ return "rospeex_msgs/SpeechRecognitionRequest"; };
